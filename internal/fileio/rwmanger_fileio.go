...
func (fm *FileIORWManager) Sync() (err error) { _ = "STUB: not implemented"; return nil }

// Release is a wrapper around the reduceUsing method
func (fm *FileIORWManager) Release() (err error) { _ = "STUB: not implemented"; return nil }

func (fm *FileIORWManager) Size() int64 { _ = "STUB: not implemented"; return 0 }

// Close will remove the cache in the fdm of the specified path, and call the close method of the os of the file
func (fm *FileIORWManager) Close() (err error) { _ = "STUB: not implemented"; return nil }
